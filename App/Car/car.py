...
port_recive = 8888         # Port to listen on (non-privileged ports are > 1023)
...
with open('CarOut.txt', 'w') as file:  # Open the file for writing
    try:
...
with open('CarOut.txt', 'a') as file:  # Append to the file
