...
port_recive = 8887         # Port to listen on (non-privileged ports are > 1023)
...
with open('BodyOut.txt', 'w') as file:  # Open the file for writing
    try:
...
with open('BodyOut.txt', 'a') as file:  # Append to the file
